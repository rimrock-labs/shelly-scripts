...
function getFanSwitchIp(e)
{
      ...
      e.code == 200)
  {
    ...
    console.log("Discovered " + context.fan_switch_id + " -> " + context.fan_switch_ip);
  }
  else
  {
    console.log("Unable to reach Shelly cloud!");
  }
}
...
function init()
{
  ...
  Shelly.addStatusHandler(function (e) {
        ...
        e.name == "switch")
    {
      ...
      {
        console.log("Updating Ceiling Fan: " + isFanOn);
        Shelly.call(
          "HTTP.GET",
      ...
      {
        console.log("Fan switch IP not yet set.");
      }
    }
  });
}
